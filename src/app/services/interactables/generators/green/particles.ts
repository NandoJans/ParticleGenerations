...
export const greenParticleGenerators = [
  {
    ...
    baseCost: new Num(1, 0), cost: new Num(1, 0), increase: new Num(5, 1), scaling: new Num(1.5, 0), scalingStart: new Num(1, 150), bought: new Num(0, 0), currency: 'greenParticles',
    ...
    requirement: ['holding', 'greens', new Num(1, 0)], nav: 'green', subNav: 'greenGenerators'
  },
  {
    name: 'green-generator-2', displayName: 'Green Generator 2', auto: false, style: 'green-style',
    baseCost: new Num(5, 0), cost: new Num(5, 0), increase: new Num(2.5, 1), scaling: new Num(1.5, 0), scalingStart: new Num(1, 150), bought: new Num(0, 0), currency: 'greenParticles',
  ...
  },
  {
    ...
    baseCost: new Num(2.5, 1), cost: new Num(2.5, 1), increase: new Num(1.25, 2), scaling: new Num(1.5, 0), scalingStart: new Num(1, 150), bought: new Num(0, 0), currency: 'greenParticles',
  ...
  },
  {
    ...
    baseCost: new Num(5, 3), cost: new Num(5, 3), increase: new Num(5, 1), scaling: new Num(1.5, 0), scalingStart: new Num(1, 150), bought: new Num(0, 0), currency: 'greenParticles',
  ...
  },
  {
    ...
    baseCost: new Num(1, 5), cost: new Num(1, 5), increase: new Num(1, 2), scaling: new Num(1.5, 0), scalingStart: new Num(1, 150), bought: new Num(0, 0), currency: 'greenParticles',
...

  {
    ...
    requirement: ['holding', 'greenParticles', new Num(1, 30)], nav: 'green', subNav: 'nuclearDecay'
  },
  {
