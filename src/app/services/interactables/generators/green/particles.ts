...
export const greenParticleGenerators = [
  {
    ...
    generates: 'greenEnergy', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'green-particles', resetId: 'greenParticleGenerators', unlocked: false,
  ...
  },
  {
    ...
    generates: 'green-generator-1', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'green-particles', resetId: 'greenParticleGenerators', unlocked: false,
    requirement: ['holding', 'greens', new Num(1, 0)], nav: 'green', subNav: 'greenGenerators', globalMultiplier: 'greenParticleGenerators',
  },
  {
    ...
    generates: 'green-generator-2', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'green-particles', resetId: 'greenParticleGenerators', unlocked: false,
    requirement: ['holding', 'greens', new Num(1, 0)], nav: 'green', subNav: 'greenGenerators', globalMultiplier: 'greenParticleGenerators',
  },
  {
    ...
    generates: 'green-generator-3', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'green-particles', resetId: 'greenParticleGenerators', unlocked: false,
    requirement: ['holding', 'greens', new Num(1, 0)], nav: 'green', subNav: 'greenGenerators', globalMultiplier: 'greenParticleGenerators',
  },
  {
    ...
    generates: 'green-generator-4', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'green-particles', resetId: 'greenParticleGenerators', unlocked: false,
    requirement: ['holding', 'greens', new Num(1, 0)], nav: 'green', subNav: 'greenGenerators', globalMultiplier: 'greenParticleGenerators',
  },
