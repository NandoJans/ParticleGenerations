...
export const greenParticleGenerators = [
  {
    ...
    baseCost: new Num(1, 0), cost: new Num(1, 0), increase: new Num(5, 1), scaling: new Num(3, 0), scalingStart: new Num(1, 5000), bought: new Num(0, 0), currency: 'greenParticles',
  ...
  },
  {
    ...
    baseCost: new Num(5, 0), cost: new Num(5, 0), increase: new Num(2.5, 1), scaling: new Num(3, 0), scalingStart: new Num(1, 5000), bought: new Num(0, 0), currency: 'greenParticles',
  ...
  },
  {
    ...
    baseCost: new Num(2.5, 1), cost: new Num(2.5, 1), increase: new Num(1.25, 2), scaling: new Num(3, 0), scalingStart: new Num(1, 5000), bought: new Num(0, 0), currency: 'greenParticles',
  ...
  },
  {
    ...
    baseCost: new Num(5, 3), cost: new Num(5, 3), increase: new Num(5, 1), scaling: new Num(3, 0), scalingStart: new Num(1, 5000), bought: new Num(0, 0), currency: 'greenParticles',
  ...
  },
  {
    ...
    baseCost: new Num(1, 5), cost: new Num(1, 5), increase: new Num(1, 2), scaling: new Num(3, 0), scalingStart: new Num(1, 5000), bought: new Num(0, 0), currency: 'greenParticles',
