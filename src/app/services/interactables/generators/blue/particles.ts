...
export const blueParticleGenerators = [
  {
    name: 'blue-neutron-generator-1', displayName: 'Blue Neutron Generator 1', auto: false, style: 'even generator-neutron-style', noMax: true,
  ...
  {
    name: 'blue-neutron-generator-2', displayName: 'Blue Neutron Generator 2', auto: false, style: 'uneven generator-neutron-style', noMax: true, scalingStart: new Num(1, 19),
  ...
  {
    name: 'blue-neutron-generator-3', displayName: 'Blue Neutron Generator 3', auto: false, style: 'even generator-neutron-style', noMax: true, scalingStart: new Num(1, 19),
  ...
  {
    name: 'blue-generator-1', displayName: 'Blue Generator 1', auto: false, style: 'even generator-blue-style',
  ...
  {
    name: 'blue-generator-2', displayName: 'Blue Generator 2', auto: false, style: 'uneven generator-blue-style',
    baseCost: new Num(1, 60), cost: new Num(1, 37), increase: new Num(1, 10), scaling: new Num(4, 0), bought: new Num(0, 0), currency: 'blueParticles',
  ...
  {
    name: 'blue-generator-3', displayName: 'Blue Generator 3', auto: false, style: 'even generator-blue-style',
    baseCost: new Num(1, 70), cost: new Num(1, 40), increase: new Num(1, 15), scaling: new Num(6, 0), bought: new Num(0, 0), currency: 'blueParticles',
  ...
  {
    name: 'blue-generator-4', displayName: 'Blue Generator 4', auto: false, style: 'uneven generator-blue-style',
    baseCost: new Num(1, 80), cost: new Num(1, 60), increase: new Num(1, 20), scaling: new Num(8, 0), bought: new Num(0, 0), currency: 'blueParticles',
  ...
  {
    name: 'blue-generator-5', displayName: 'Blue Generator 5', auto: false, style: 'even generator-blue-style',
    baseCost: new Num(1, 90), cost: new Num(1, 90), increase: new Num(1, 25), scaling: new Num(1, 1), bought: new Num(0, 0), currency: 'blueParticles',
