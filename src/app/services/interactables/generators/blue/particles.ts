...
export const blueParticleGenerators = [
  ...
  },
  {
    ...
    generates: 'blueHydrogen', baseMulMod: new Num(1, 0), baseMultiplier: new Num(1, 1), multiplier: new Num(1, 1), amount: new Num(0, 0) , type: 'blue-particles', resetId: 'blue', unlocked: false,
  ...
  },
  {
    ...
    generates: 'blue-generator-1', baseMulMod: new Num(1, 0), baseMultiplier: new Num(1, 1), multiplier: new Num(1, 1), amount: new Num(0, 0) , type: 'blue-particles', resetId: 'blue', unlocked: false,
    requirement: ['holding', 'blueParticles', new Num(1, 30)], nav: 'blue', subNav: 'blueGenerators', globalMultiplier: 'blueParticleGenerators',
  },
  {
    ...
    generates: 'blue-generator-2', baseMulMod: new Num(1, 0), baseMultiplier: new Num(1, 1), multiplier: new Num(1, 1), amount: new Num(0, 0) , type: 'blue-particles', resetId: 'blue', unlocked: false,
    requirement: ['holding', 'blueParticles', new Num(1, 30)], nav: 'blue', subNav: 'blueGenerators', globalMultiplier: 'blueParticleGenerators',
  },
  {
    ...
    generates: 'blue-generator-3', baseMulMod: new Num(1, 0), baseMultiplier: new Num(1, 1), multiplier: new Num(1, 1), amount: new Num(0, 0) , type: 'blue-particles', resetId: 'blue', unlocked: false,
    requirement: ['holding', 'blueParticles', new Num(1, 30)], nav: 'blue', subNav: 'blueGenerators', globalMultiplier: 'blueParticleGenerators',
  },
  {
    ...
    generates: 'blue-generator-4', baseMulMod: new Num(1, 0), baseMultiplier: new Num(1, 1), multiplier: new Num(1, 1), amount: new Num(0, 0) , type: 'blue-particles', resetId: 'blue', unlocked: false,
    requirement: ['holding', 'blueParticles', new Num(1, 30)], nav: 'blue', subNav: 'blueGenerators', globalMultiplier: 'blueParticleGenerators',
  },
]
