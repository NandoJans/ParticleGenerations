...
export const yellowParticleGenerators = [
  {
    ...
    generates: 'yellowPower', baseMultiplier: new Num(35, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
  ...
  },
  {
    ...
    generates: 'yellow-generator-1', baseMultiplier: new Num(30, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)]
  },
  {
    ...
    generates: 'yellow-generator-2', baseMultiplier: new Num(25, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)]
  },
  {
  ...
  },
  {
    ...
    generates: 'yellow-generator-4', baseMultiplier: new Num(15, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)]
  },
