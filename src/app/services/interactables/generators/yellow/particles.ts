...
export const yellowParticleGenerators = [
  {
    ...
    generates: 'yellowPower', baseMulMod: new Num(1, 0), baseMultiplier: new Num(25, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
  ...
  },
  {
    ...
    generates: 'yellow-generator-1', baseMulMod: new Num(1, 0), baseMultiplier: new Num(20, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)], nav: 'yellow', subNav: 'yellowGenerators', globalMultiplier: 'yellowParticleGenerators',
  },
  {
    ...
    generates: 'yellow-generator-2', baseMulMod: new Num(1, 0), baseMultiplier: new Num(20, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)], nav: 'yellow', subNav: 'yellowGenerators', globalMultiplier: 'yellowParticleGenerators',
  },
  {
    ...
    generates: 'yellow-generator-3', baseMulMod: new Num(1, 0), baseMultiplier: new Num(20, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)], nav: 'yellow', subNav: 'yellowGenerators', globalMultiplier: 'yellowParticleGenerators',
  },
  {
    ...
    generates: 'yellow-generator-4', baseMulMod: new Num(1, 0), baseMultiplier: new Num(20, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)], nav: 'yellow', subNav: 'yellowGenerators', globalMultiplier: 'yellowParticleGenerators',
  },

  {
    ...
    generates: 'yellowFusion', baseMulMod: new Num(1, 0), baseMultiplier: new Num(0, 0), multiplier: new Num(0, 0), amount: new Num(0, 0) , type: 'yellow-fusion', resetId: 'yellowFusionGenerators', unlocked: true,
