...
export const yellowParticleGenerators = [
  {
    ...
    generates: 'yellowPower', baseMultiplier: new Num(25, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'yellow-particles', resetId: 'yellowParticleGenerators', unlocked: true,
    requirement: ['holding', 'yellowParticles', new Num(1, 2)], nav: 'yellow', subNav: 'yellowGenerators'
  },
  {
...

  {
    ...
    requirement: ['upgrade', 'unlock-yellow-fusion', new Num(1, 0)], nav: '', subNav: ''
  },
]
