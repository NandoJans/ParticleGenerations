...
export const redAcceleratorGenerators = [
  {
    ...
    requirement: ['holding', 'redParticles', new Num(1, 20)], nav: 'red', subNav: 'redAccelerators'
  },
  {
    ...
    generates: 'red-accelerator-generator-1', baseMultiplier: new Num(2, 0), multiplier: new Num(1, 0), amount: new Num(0, 0) , type: 'red-accelerators', resetId: 'redAccelerators', unlocked: false,
    requirement: [''], nav: 'red', subNav: 'redAccelerators'
  },
]
