...
export const redAcceleratorGenerators = [
  {
    name: 'red-accelerator-generator-1', displayName: 'Red Accelerator Generator 1', auto: false, style: 'even generator-accelerator-style',
  ...
  {
    name: 'red-accelerator-generator-2', displayName: 'Red Accelerator Generator 2', auto: false, style: 'uneven generator-accelerator-style',
