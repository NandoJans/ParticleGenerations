...
export const redParticleGenerators = [
  {
    ...
    requirement: ['none'], nav: 'red', subNav: 'redParticles'
  },
  {
    ...
    requirement: ['upgrade', 'red-generator-extension', new Num(1, 0)], nav: 'red', subNav: 'redParticles'
  },
  {
    ...
    requirement: ['upgrade', 'red-generator-extension', new Num(2, 0)], nav: 'red', subNav: 'redParticles'
  },
  {
    ...
    requirement: ['upgrade', 'red-generator-extension', new Num(3, 0)], nav: 'red', subNav: 'redParticles'
  },
  {
    ...
    requirement: ['upgrade', 'red-generator-extension', new Num(4, 0)], nav: 'red', subNav: 'redParticles'
  },
]
