...
export const purpleParticleGenerators = [
  {
    ...
    baseCost: new Num(1, 0), cost: new Num(1, 0), increase: new Num(5, 0), scaling: new Num(2, 0), bought: new Num(0, 0), currency: 'purpleParticles',
    generates: 'purpleVoid', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purple', unlocked: false,
  ...
  },
  {
    ...
    baseCost: new Num(2, 0), cost: new Num(2, 0), increase: new Num(2.5, 1), scaling: new Num(2, 0), bought: new Num(0, 0), currency: 'purpleParticles',
    generates: 'purple-generator-1', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purple', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators', globalMultiplier: 'purpleParticleGenerators',
  },
  {
    name: 'purple-generator-3', displayName: 'Purple Generator 3', auto: false, style: 'purple-style',
    baseCost: new Num(3, 0), cost: new Num(3, 0), increase: new Num(1.25, 2), scaling: new Num(2, 0), bought: new Num(0, 0), currency: 'purpleParticles',
    generates: 'purple-generator-2', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purple', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators', globalMultiplier: 'purpleParticleGenerators',
  },
  {
    ...
    generates: 'purple-generator-3', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purple', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators', globalMultiplier: 'purpleParticleGenerators',
  },
  {
    ...
    generates: 'purple-generator-4', baseMulMod: new Num(1, 0), baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purple', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators', globalMultiplier: 'purpleParticleGenerators',
  },
