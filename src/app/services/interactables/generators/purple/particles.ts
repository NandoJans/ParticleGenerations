...
export const purpleParticleGenerators = [
  ...
  },
  {
    ...
    baseCost: new Num(1, 1), cost: new Num(1, 1), increase: new Num(2.5, 1), scaling: new Num(2, 0), bought: new Num(0, 0), currency: 'purpleParticles',
  ...
  },
  {
    ...
    baseCost: new Num(1, 2), cost: new Num(1, 2), increase: new Num(1.25, 2), scaling: new Num(2, 0), bought: new Num(0, 0), currency: 'purpleParticles',
