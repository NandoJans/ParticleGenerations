...
export const purpleParticleGenerators = [
  {
    name: 'purple-generator-1', displayName: 'Purple Generator 1', auto: false, style: 'purple-style', scalingStart: new Num(1, 110),
  ...
  {
    name: 'purple-generator-2', displayName: 'Purple Generator 2', auto: false, style: 'purple-style', scalingStart: new Num(1, 110),
  ...
  {
    name: 'purple-generator-3', displayName: 'Purple Generator 3', auto: false, style: 'purple-style', scalingStart: new Num(1, 110),
