...
export const purpleParticleGenerators = [
  {
    ...
    generates: 'purpleVoid', baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purpleParticleGenerators', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators'
  },
  {
    ...
    generates: 'purple-generator-1', baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purpleParticleGenerators', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators'
  },
  {
    ...
    generates: 'purple-generator-2', baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purpleParticleGenerators', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators'
  },
  {
    ...
    generates: 'purple-generator-3', baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purpleParticleGenerators', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators'
  },
  {
    ...
    generates: 'purple-generator-4', baseMultiplier: new Num(5, 0), multiplier: new Num(5, 0), amount: new Num(0, 0) , type: 'purple-particles', resetId: 'purpleParticleGenerators', unlocked: false,
    requirement: ['holding', 'purples', new Num(1, 0)], nav: 'purple', subNav: 'purpleGenerators'
  },
]
