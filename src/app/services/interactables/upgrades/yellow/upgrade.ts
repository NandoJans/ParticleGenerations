...
export const yellowUpgrades: Upgrade[] = [
  {
    ...
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgades', style: 'yellow-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['yellows', new Num(1, 0)],
