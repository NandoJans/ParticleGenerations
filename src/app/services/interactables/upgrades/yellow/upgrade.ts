...
export const yellowUpgrades: Upgrade[] = [
  {
    name: 'yellow-repeatable-multiplier', displayName: 'Multiply 2', description: 'Multiply red particle generators by 2.00x', auto: false, scalingStart: new Num(1, 10000000),
    ...
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'yellow-upgrades-repeatable', resetId: 'yellow', style: 'yellow-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: (self: Upgrade) => {
  ...
  {
    name: 'yellow-particle-multiplier', displayName: 'Multiply particles by 2', description: 'Multiply yellow particles gain by 2.00x', auto: false,
  ...
  {
    name: 'yellow-based-multiplier', displayName: 'Yellows based multiplier', description: 'Gain a 0.2x multiplier to red particle generators for each yellow you have.', auto: false,
  ...
  {
    name: 'yellow-based-accelerator-multiplier', displayName: 'Yellows based accelerator multiplier', description: 'Gain a 0.2x multiplier to red accelerator generators for each yellow you have.', auto: false,
  ...
  {
    name: 'increase-red-accelerator-upgrade-1', displayName: 'Red accelerator buffer 1', description: 'Increases the multiplier of the first red accelerator upgrade by 1.', auto: false,
  ...
  {
    name: 'increase-red-accelerator-upgrade-2', displayName: 'Red accelerator buffer 2', description: 'Increases the multiplier of the second red accelerator upgrade by 1.5.', auto: false,
  ...
  {
    name: 'increase-red-accelerator-upgrade-3', displayName: 'Red accelerator buffer 3', description: 'Increases the multiplier of the third red accelerator upgrade by 2.', auto: false,
  ...
  {
    name: 'increase-red-generator-extension', displayName: 'Red extension booster', description: 'Multiply the multiplier of the red generator extension by 2.', auto: false,
  ...
  {
    name: 'increase-red-generator-booster', displayName: 'Red booster extension', description: 'Increases the multiplier of the red generator booster by 0.6.', auto: false,
