...
export const yellowUpgrades: Upgrade[] = [
  {
    ...
    action: new Action('basedOnUpgrade', 'redParticleGenerators', new Num(1, 0), 'bought', 'yellow-repeatable-multiplier'), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseCost: new Num(1,0), cost: new Num(1, 0), increase: new Num(1,1), scaling: new Num(1, 0), bought: new Num(0, 0), currency: 'yellowParticles',
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'yellow-upgrades-repeatable', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('basedOnUpgrade', 'yellowParticlesGain', new Num(1, 0), 'bought', 'yellow-particle-multiplier'), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    action: new Action('basedOnHolding', 'redParticleGenerators', new Num(0.2, 0), 'amount', 'yellows'), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('basedOnHolding', 'redAcceleratorGenerators', new Num(0.2, 0), 'amount', 'yellows'), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('amplifyGenerators', 'red-particles', new Num(3, 0), 'baseMultiplier'), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('increaseBuffer', 'red-accelerator-multiplier-1', new Num(1, 0)), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('increaseBuffer', 'red-accelerator-multiplier-2', new Num(1.5, 0)), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('increaseBuffer', 'red-accelerator-multiplier-3', new Num(2, 0)), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('increaseBuffer', 'red-generator-extension', new Num(2, 0), 'buffer'), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('increaseBuffer', 'red-generator-booster', new Num(0.6, 0), 'buffer'), nav: 'yellow', subNav: 'yellowUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'yellow-upgrades', resetId: 'yellow-upgrades', style: 'yellow-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['yellows', new Num(1, 0)],
    action: new Action('amplifyGenerator', 'red-accelerator-generator-1', ['none'], 'requirement'), nav: 'yellow', subNav: 'yellowUpgrades'
  }
]
