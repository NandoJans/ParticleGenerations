...
export const yellowFusionUpgrades = [
  {
    ...
    action: new Action('amplifyGenerator', 'yellow-fusion-generator', new Num(1, 0), 'amount'), nav: 'yellow', subNav: 'yellowFusion'
  },
  {
    name: 'accelerate-yellow-fusion', displayName: 'Better condition', description: 'Make better conditions to accelerate fusion.', auto: false, noMax: true,
    baseCost: new Num(1,32), cost: new Num(1, 32), increase: new Num(1,1), scaling: new Num(1, 0), bought: new Num(0, 0), currency: 'yellowParticles',
    ...
    action: new Action('basedOnUpgrade', 'yellowFusion', new Num(1, 0), 'bought', 'accelerate-yellow-fusion'), limit: new Num(4, 1), nav: 'yellow', subNav: 'yellowFusion'
  },
  {
    name: 'increase-yellow-fusion', displayName: 'Increase fusion rate', description: 'Increases the fusion rate to fuse more at the same time.', auto: false, noMax: true,
    ...
    action: new Action('basedOnUpgrade', 'yellowFusion', new Num(1, 0), 'bought', 'increase-yellow-fusion'), limit: new Num(2, 1), nav: 'yellow', subNav: 'yellowFusion'
  },
]
