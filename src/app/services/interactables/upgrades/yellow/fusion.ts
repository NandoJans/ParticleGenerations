...
export const yellowFusionUpgrades = [
  ...
  },
  {
    ...
    action: new Action('basedOnUpgrade', 'yellowFusion', new Num(1, 0), 'bought', 'accelerate-yellow-fusion'), limit: new Num(2, 1)
  },
  {
    ...
    action: new Action('basedOnUpgrade', 'yellowFusion', new Num(1, 0), 'bought', 'increase-yellow-fusion'), limit: new Num(1, 1)
  },
]
