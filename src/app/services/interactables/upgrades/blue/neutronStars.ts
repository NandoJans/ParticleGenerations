...
export const blueNeutronStars: Upgrade[] = [
  ...
  {
    name: 'blue-light-amplifier', displayName: 'Blue Light Amplifier', description: 'Increases the blue light effect.', auto: false, limit: new Num(1.3, 1), scalingStart: new Num(1, 30),
    ...
    action: new Action('basedOnUpgrade', 'blueLightPower', new Num(1, 0), 'bought', 'blue-light-amplifier'), nav: 'blue', subNav: 'neutronStars', noMax: true,
  },
  {
    name: 'blue-light-increaser', displayName: 'Increase Blue Light', description: 'Generates 2x more blue light.', auto: false, scalingStart: new Num(1, 50),
    baseCost: new Num(1,4), cost: new Num(1, 4), increase: new Num(2.5,1), scaling: new Num(2, 0), bought: new Num(0, 0), currency: 'blueLight',
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'blue-light-upgrade', resetId: 'blue-light-upgrade', style: 'light-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['blues', new Num(5, 0)],
  ...
  {
    name: 'yellow-fusion-accelerator', displayName: 'Yellow Fusion Accelerator', description: 'Makes yellow fusion 1e5x faster.', auto: false, scalingStart: new Num(1, 100),
    baseCost: new Num(1,2), cost: new Num(1, 2), increase: new Num(1,1), scaling: new Num(1, 1), bought: new Num(0, 0), currency: 'blueLight',
    baseBuffer: new Num(1, 5), buffer: new Num(1, 5), amount: new Num(0, 0), type: 'blue-light-upgrade', resetId: 'blue-light-upgrade', style: 'light-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['blues', new Num(5, 0)],
    action: new Action('basedOnUpgrade', 'yellowFusion', new Num(1, 0), 'bought', 'yellow-fusion-accelerator'), nav: 'blue', subNav: 'neutronStars'
  },
  {
    name: 'yellow-fusion-effect-increaser', displayName: 'Increase Fusion Effect', description: 'Increases the power of the yellow fusion effect.', auto: false, scalingStart: new Num(1, 50),
    baseCost: new Num(1,3), cost: new Num(1, 3), increase: new Num(1,3), scaling: new Num(5, 0), bought: new Num(0, 0), currency: 'blueLight',
