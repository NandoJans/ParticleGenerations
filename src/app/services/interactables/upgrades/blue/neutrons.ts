...
export const blueNeutronUpgrades = [
  {
    ...
    action: new Action('amplifyUpgradeIncremental', 'blue-neutron-amplifier', '', 'buffer', 'blue-neutron-amplifier'), nav: 'blue', subNav: 'blueNeutrons', noMax: true,
  },
  {
    ...
    action: new Action('basedOnUpgrade', 'blueNeutronGenerators', new Num(1, 0), 'bought', '2x-blue-neutron-generator-boost'), nav: 'blue', subNav: 'blueNeutrons'
  },
  {
    ...
    action: new Action('basedOnUpgrade', 'blueNeutronGenerators', new Num(1, 0), 'bought', '5x-blue-neutron-generator-boost'), nav: 'blue', subNav: 'blueNeutrons'
  }
]
