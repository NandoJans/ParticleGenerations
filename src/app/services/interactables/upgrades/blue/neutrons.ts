...
export const blueNeutronUpgrades = [
  {
    ...
    baseBuffer: new Num(1.2, 0), buffer: new Num(1.2, 0), amount: new Num(0, 0), type: 'blue-neutron-upgrade', resetId: 'blue-neutron-upgrade', style: 'blue-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['blues', new Num(2, 0)],
