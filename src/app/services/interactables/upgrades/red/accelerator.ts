...
export const redAccelerators: Upgrade[] = [
  {
    ...
    action: new Action('basedOnUpgrade', 'redAcceleratorGenerators', new Num(1, 0), 'bought', 'red-accelerator-multiplier-1'), nav: 'red', subNav: 'redAccelerators'
  },
  {
    ...
    action: new Action('basedOnUpgrade', 'redAcceleratorGenerators', new Num(1, 0), 'bought', 'red-accelerator-multiplier-2'), nav: 'red', subNav: 'redAccelerators'
  },
  {
    ...
    action: new Action('basedOnUpgrade', 'redAcceleratorGenerators', new Num(1, 0), 'bought', 'red-accelerator-multiplier-3'), nav: 'red', subNav: 'redAccelerators'
  },
]
