...
export const redAccelerators: Upgrade[] = [
  {
    ...
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'red-accelerators', resetId: 'red-accelerators', style: 'red-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['redParticles', new Num(1, 20)],
  ...
  },
  {
    ...
    baseBuffer: new Num(3, 0), buffer: new Num(3, 0), amount: new Num(0, 0), type: 'red-accelerators', resetId: 'red-accelerators', style: 'red-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['redParticles', new Num(1, 20)],
  ...
  },
  {
    ...
    baseBuffer: new Num(4, 0), buffer: new Num(4, 0), amount: new Num(0, 0), type: 'red-accelerators', resetId: 'red-accelerators', style: 'red-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['redParticles', new Num(1, 20)],
