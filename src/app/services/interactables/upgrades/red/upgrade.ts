...
export const redUpgrades: Upgrade[] = [
  ...
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'red-upgrades', resetId: 'red-upgrades', style: 'red-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['redParticles', new Num(1, 40)],
    action: new Action('amplifyUpgrade', 'red-generator-booster', ['none'], 'requirement'), nav: 'red', subNav: 'redUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'red-upgrades', resetId: 'red-upgrades', style: 'red-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['redParticles', new Num(1, 40)],
    action: new Action('basedOnHolding', 'redAcceleratorGenerators', new Num(1, 0), 'exponent', 'redParticles'), nav: 'red', subNav: 'redUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'red-upgrades', resetId: 'red-upgrades', style: 'red-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['redParticles', new Num(1, 40)],
    action: new Action('increaseBuffer', 'red-generator-booster', new Num(0.2, 0)), nav: 'red', subNav: 'redUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'red-upgrades', resetId: 'red-upgrades', style: 'red-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['redParticles', new Num(1, 40)],
    action: new Action('amplifyUpgrade', 'red-generator-booster', new Num(2, 0), 'scaling'), nav: 'red', subNav: 'redUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'red-upgrades', resetId: 'red-upgrades', style: 'red-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['redParticles', new Num(1, 40)],
    action: new Action('increaseBuffer', 'red-accelerator-multiplier-1', new Num(0.5, 0)), nav: 'red', subNav: 'redUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'red-upgrades', resetId: 'red-upgrades', style: 'red-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['redParticles', new Num(1, 40)],
    action: new Action('increaseBuffer', 'red-accelerator-multiplier-2', new Num(0.5, 0)), nav: 'red', subNav: 'redUpgrades'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'red-upgrades', resetId: 'red-upgrades', style: 'red-style', unlocked: false, oneTime: true, resets: 'none', requirement: ['redParticles', new Num(1, 40)],
    action: new Action('increaseBuffer', 'red-accelerator-multiplier-3', new Num(0.5, 0)), nav: 'red', subNav: 'redUpgrades'
  },
]
