...
export const redUpgrades: Upgrade[] = [
  ...
  {
    name: 'unlock-red-generators-booster', displayName: 'Unlock Generator Booster', description: 'Unlock the red generator booster upgrade.', auto: false,
  ...
  {
    name: 'red-booster-multiplier-upgrade', displayName: 'Booster Multiplier Amplifier', description: 'Increase the multiplier of the red generator booster by 0.1.', auto: false,
  ...
  {
    name: 'red-booster-scaling-upgrade', displayName: 'Booster Cost Decreaser', description: 'Set the cost scaling of the red generator booster to 2.', auto: false,
  ...
  {
    name: 'red-accelerator-booster-1', displayName: 'Boost accelerator upgrade 2', description: 'Increases the multiplier of the first red accelerator upgrade by 0.5.', auto: false,
  ...
  {
    name: 'red-accelerator-booster-2', displayName: 'Boost accelerator upgrade 3', description: 'Increases the multiplier of the second red accelerator upgrade by 1.', auto: false,
  ...
  {
    name: 'red-accelerator-booster-3', displayName: 'Boost accelerator upgrade 4', description: 'Increases the multiplier of the third red accelerator upgrade by 1.5.', auto: false,
