...
export const redGeneratorUpgrades: Upgrade[] = [
  {
    ...
    action: new Action('basedOnUpgrade', 'redParticleGenerators', new Num(2, 0), 'bought', 'red-generator-extension', ['red-generator-extension-upgrade', 'bought', new Num(1, 0)]),
  },
  {
    name: 'red-generator-booster', displayName: 'Red Generator Booster', description: 'Boosts generators', auto: false,
    baseCost: new Num(1,3), cost: new Num(1, 3), increase: new Num(2,0), scaling: new Num(2, 0), bought: new Num(0, 0), currency: 'redParticles',
    baseBuffer: new Num(1.2, 0), buffer: new Num(1.2, 0), amount: new Num(0, 0), type: 'red-particles', resetId: 'red-particles', style: 'red-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['none', new Num(0, 0)],
    action: new Action('basedOnUpgrade', 'redParticleGenerators', new Num(1.2, 0), 'bought', 'red-generator-booster')
  },
]
