...
export const darkenergyUpgrades: Upgrade[] = [
  ...
  },
  {
    ...
    baseBuffer: new Num(1, 25), buffer: new Num(1, 25), amount: new Num(0, 0), type: 'dark-upgrade', resetId: 'dark-upgrade', style: 'sacrifice-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 1)],
    action: [
