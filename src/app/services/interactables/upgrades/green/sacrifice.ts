...
export const greenSacrifice: Upgrade[] = [
  {
    name: 'red-particles-sacrifice', displayName: 'Sacrifice Red Particles', description: '', auto: false,
  ...
  {
    name: 'yellow-particles-sacrifice', displayName: 'Sacrifice Yellow Particles', description: '', auto: false,
  ...
  {
    name: 'green-particles-sacrifice', displayName: 'Sacrifice Green Particles', description: '', auto: false,
