...
export const greenSacrifice: Upgrade[] = [
  {
    ...
    action: new Action('increaseGreenSouls', 'greenSouls', new Num(1, 0), 'bought', 'red-particles-sacrifice'), nav: 'green', subNav: 'greenSacrifice'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'green-sacrifices', resetId: 'green-sacrifices', style: 'sacrifice-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 0)],
    action: new Action('increaseGreenSouls', 'greenSouls', new Num(1, 0), 'bought', 'yellow-particles-sacrifice'), nav: 'green', subNav: 'greenSacrifice'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'green-sacrifices', resetId: 'green-sacrifices', style: 'sacrifice-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 0)],
    action: new Action('increaseGreenSouls', 'greenSouls', new Num(1, 0), 'bought', 'green-particles-sacrifice'), nav: 'green', subNav: 'greenSacrifice'
  },
]
