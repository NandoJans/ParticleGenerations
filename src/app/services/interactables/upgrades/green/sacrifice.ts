...
export const greenSacrifice: Upgrade[] = [
  {
    ...
    baseCost: new Num(1,5000), cost: new Num(1, 5000), increase: new Num(1,5000), scaling: new Num(1, 0), bought: new Num(0, 0), currency: 'redParticles',
    ...
    action: new Action('increaseHolding', 'greenSouls', new Num(1, 0), 'bought', 'red-particles-sacrifice')
  },
  {
    ...
    baseCost: new Num(1,50), cost: new Num(1, 50), increase: new Num(1,50), scaling: new Num(1, 0), bought: new Num(0, 0), currency: 'yellowParticles',
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'green-sacrifices', resetId: 'green-sacrifices', style: 'sacrifice-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 0)],
    action: new Action('increaseHolding', 'greenSouls', new Num(1, 0), 'bought', 'yellow-particles-sacrifice')
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'green-sacrifices', resetId: 'green-sacrifices', style: 'sacrifice-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 0)],
    action: new Action('increaseHolding', 'greenSouls', new Num(1, 0), 'bought', 'green-particles-sacrifice')
  },
]
