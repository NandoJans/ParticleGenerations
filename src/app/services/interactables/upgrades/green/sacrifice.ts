...
export const greenSacrifice: Upgrade[] = [
  {
    ...
    action: new NewAction('increase holding greenSouls basedon upgrade red-particles-sacrifice bought mul multiplier greenSoulsGain', new Num(1, 0)), nav: 'green', subNav: 'greenSacrifice'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'green-sacrifices', resetId: 'green-sacrifices', style: 'sacrifice-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 0)],
    action: new NewAction('increase holding greenSouls basedon upgrade yellow-particles-sacrifice bought mul multiplier greenSoulsGain', new Num(1, 0)), nav: 'green', subNav: 'greenSacrifice'
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'green-sacrifices', resetId: 'green-sacrifices', style: 'sacrifice-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 0)],
    action: new NewAction('increase holding greenSouls basedon upgrade green-particles-sacrifice bought mul multiplier greenSoulsGain', new Num(1, 0)), nav: 'green', subNav: 'greenSacrifice'
  },
]
