...
export const greenUpgrades: Upgrade[] = [
  {
    ...
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'green-upgrade', resetId: 'green-upgrades-repeatable', style: 'green-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greens', new Num(1, 0)],
    action: (self: Upgrade) => {
