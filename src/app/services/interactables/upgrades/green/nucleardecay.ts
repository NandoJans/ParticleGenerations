...
export const nuclearDecayUpgrades: Upgrade[] = [
  {
    ...
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'nuclear-decay', resetId: 'nuclear', style: 'nuclear-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greenParticles', new Num(1, 35)],
    action: (self: Upgrade) => {
  ...
  },
  {
    ...
    baseBuffer: new Num(5, 0), buffer: new Num(5, 0), amount: new Num(0, 0), type: 'nuclear-decay', resetId: 'nuclear', style: 'nuclear-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greenParticles', new Num(1, 35)],
    action: (self: Upgrade) => {
      if (HoldingsService.get('limitedUpgradeCount').greq(new Num(1, 1))) {
        const buff = self.buffer.pow(self.bought, false);
  ...
  },
  {
    ...
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'nuclear-decay', resetId: 'nuclear', style: 'nuclear-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['greenParticles', new Num(1, 35)],
    action: (self: Upgrade) => {
      if (HoldingsService.get('limitedUpgradeCount').greq(new Num(1, 1))) {
        // @ts-ignore
