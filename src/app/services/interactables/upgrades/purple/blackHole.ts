...
export const blackHoleUpgrades: Upgrade[] = [
...

  {
    ...
    baseBuffer: new Num(1.1, 0), buffer: new Num(1.1, 0), amount: new Num(0, 0), type: 'black-hole-upgrades', resetId: 'purple', style: 'black-hole-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['purples', new Num(5, 0)],
    action: (self: Upgrade) => {
  ...
  },
  {
    ...
    baseBuffer: new Num(1.2, 0), buffer: new Num(1.2, 0), amount: new Num(0, 0), type: 'black-hole-upgrades', resetId: 'purple', style: 'black-hole-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['purples', new Num(5, 0)],
    action: (self: Upgrade) => {
      let buff: Num | undefined = self.buffer.pow(self.bought, false)
      GlobalMultipliersService.correct('gravityGenerators', buff)
      return buff;
  ...
  },
  {
    ...
    baseBuffer: new Num(1.3, 0), buffer: new Num(1.3, 0), amount: new Num(0, 0), type: 'black-hole-upgrades', resetId: 'purple', style: 'black-hole-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['purples', new Num(5, 0)],
    action: (self: Upgrade) => {
      let buff: Num | undefined = self.buffer.pow(self.bought, false)
      GlobalMultipliersService.correct('gravityGenerators', buff)
      return buff;
  ...
  },
  {
    ...
    baseCost: new Num(1,10), cost: new Num(1, 10), increase: new Num(1,1), scaling: new Num(1, 1), bought: new Num(0, 0), currency: 'blackHoleMass',
    baseBuffer: new Num(1, 0), buffer: new Num(1, 0), amount: new Num(0, 0), type: 'black-hole-upgrades', resetId: 'purple', style: 'black-hole-style', unlocked: false, oneTime: false, resets: 'none', requirement: ['purples', new Num(5, 0)],
    action: (self: Upgrade) => {
  ...
  {
    name: 'purple-galaxy', displayName: 'Purple Galaxy', description: 'Increase the effect of all purple void effects.', auto: false, limit: new Num(0, 0),
    baseCost: new Num(1,110), cost: new Num(1, 110), increase: new Num(1,0), scaling: new Num(1, 0), bought: new Num(0, 0), currency: 'gravity',
    baseBuffer: new Num(2, 0), buffer: new Num(2, 0), amount: new Num(0, 0), type: 'galaxies', resetId: 'purple', style: 'black-hole-style', unlocked: false, oneTime: false, resets: 'purpleGalaxy', requirement: ['purples', new Num(5, 0)],
    action: (self: Upgrade) => {
      let buff: Num | undefined = self.buffer.pow(self.bought, false)
