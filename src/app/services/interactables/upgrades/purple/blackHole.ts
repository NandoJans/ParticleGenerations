...
export const blackHoleUpgrades: Upgrade[] = [
  {
    ...
    }, nav: 'purple', subNav: 'blackHole'
  },

  {
    name: 'increased-black-hole-size', displayName: 'Increase Size', description: 'Increase the size of the black hole to increase gravity gain by x1.10', auto: false, scalingStart: new Num(1, 40),
    baseCost: new Num(1,20), cost: new Num(1, 20), increase: new Num(1,1), scaling: new Num(1, 1), bought: new Num(0, 0), currency: 'blackHoleMass',
  ...
  {
    name: 'increased-black-hole-mass', displayName: 'Increase Mass', description: 'Increase the mass of the black hole to increase gravity gain by x1.20', auto: false, scalingStart: new Num(1, 40),
    baseCost: new Num(1,20), cost: new Num(1, 20), increase: new Num(1,2), scaling: new Num(1, 1), bought: new Num(0, 0), currency: 'blackHoleMass',
  ...
  {
    name: 'increased-black-hole-gravity', displayName: 'Increase Gravity', description: 'Increase the gravity of the black hole to increase gravity gain by x1.30', auto: false, scalingStart: new Num(1, 40),
    baseCost: new Num(1,20), cost: new Num(1, 20), increase: new Num(1,3), scaling: new Num(1, 1), bought: new Num(0, 0), currency: 'blackHoleMass',
  ...
  {
    name: 'increased-galaxy-amount', displayName: 'Another Galaxy', description: 'Be able to get an extra galaxy.', auto: false, scalingStart: new Num(1, 100),
