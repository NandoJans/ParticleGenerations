...
export const blackHoleUpgrades: Upgrade[] = [
  ...
  },
  {
    ...
    baseCost: new Num(1,20), cost: new Num(1, 20), increase: new Num(1,4), scaling: new Num(1, 0), bought: new Num(0, 0), currency: 'blackHoleMass',
  ...
  },
  {
    ...
    baseCost: new Num(1,20), cost: new Num(1, 20), increase: new Num(1,6), scaling: new Num(1, 0), bought: new Num(0, 0), currency: 'blackHoleMass',
  ...
  },
  {
    ...
    baseBuffer: new Num(5, 0), buffer: new Num(5, 0), amount: new Num(0, 0), type: 'galaxies', resetId: 'purple', style: 'black-hole-style', unlocked: false, oneTime: false, resets: 'purpleGalaxy', requirement: ['purples', new Num(5, 0)],
    action: (self: Upgrade) => {
      let buff: Num | undefined = self.buffer.mul(self.bought, false)
