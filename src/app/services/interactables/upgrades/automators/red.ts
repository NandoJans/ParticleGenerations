...
export const redAutomators: Automator[] = [
  {
    ...
    target: 'red-particles', targetType: 'generators'
  },
  {
    ...
    type: 'red-automators', resetId: 'red-automators', style: 'automator', unlocked: false, active: false, requirement: ['yellows', new Num(1, 0)],
    target: 'red-accelerators', targetType: 'generators'
  },
  {
    ...
    type: 'red-automators', resetId: 'red-automators', style: 'automator', unlocked: false, active: false, requirement: ['yellows', new Num(1, 0)],
    target: 'red-generator-booster', targetType: 'upgrade'
  },
  {
    ...
    type: 'red-automators', resetId: 'red-automators', style: 'automator', unlocked: false, active: false, requirement: ['yellows', new Num(1, 0)],
    target: 'red-generator-extension', targetType: 'upgrade'
  },
  {
    ...
    type: 'red-automators', resetId: 'red-automators', style: 'automator', unlocked: false, active: false, requirement: ['yellows', new Num(1, 0)],
    target: 'red-accelerators', targetType: 'upgrades'
  }
]
