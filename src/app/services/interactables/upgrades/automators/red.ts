...
export const redAutomators: Automator[] = [
  {
    ...
    type: 'red-automators', resetId: 'red-automators', style: 'automator red-automator', unlocked: false, active: false, requirement: ['yellows', new Num(1, 0)],
  ...
  },
  {
    ...
    type: 'red-automators', resetId: 'red-automators', style: 'automator red-automator', unlocked: false, active: false, requirement: ['purples', new Num(1, 0)],
    target: 'red-upgrades', targetType: 'upgrades', nav: 'automators', subNav: 'redAutomators'
  },
  {
    ...
    type: 'red-automators', resetId: 'purple-automators', style: 'automator red-automator', unlocked: false, active: false, requirement: ['purples', new Num(1, 0)],
