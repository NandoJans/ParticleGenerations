...
export const darkAge:Challenge[] = [{
  ...
  rewardDescription: 'Increase the amount of dark energy produced by compressing.', style: 'green-challenge', resetId: 'dark-age', type: 'dark-age', prestige: 'green', unlocked: false, instantComplete: false,
