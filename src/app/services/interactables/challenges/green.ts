...
export const darkAge:Challenge[] = [{
  name: 'dark-age', displayName: 'Dark Age', description: 'while every generator is raised to the power of 0.45.', baseGoal: new Num(1, 110), goal: new Num(1, 110), currency: 'yellowParticles', completed: false, disabled: false,
