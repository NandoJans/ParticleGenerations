...
export const yellowChallenges: Challenge[] = [
  ...
  },
  {
    ...
    rewardDescription: 'Gain an extra red accelerator generator.', style: 'yellow-challenge', resetId: 'yellow-challenges', type: 'yellow-challenges', prestige: 'yellow', unlocked: false,
  ...
  },
  {
    ...
    rewardDescription: 'Yellow generators are multiplied by the amount of fifth red generators.', style: 'yellow-challenge', resetId: 'yellow-challenges', type: 'yellow-challenges', prestige: 'yellow', unlocked: false,
  ...
  },
  {
    ...
    rewardDescription: 'Red accelerators gain a multiplier based on yellow power.', style: 'yellow-challenge', resetId: 'yellow-challenges', type: 'yellow-challenges', prestige: 'yellow', unlocked: false,
  ...
  },
  {
    ...
    rewardDescription: 'First red generators boost the other generators.', style: 'yellow-challenge', resetId: 'yellow-challenges', type: 'yellow-challenges', prestige: 'yellow', unlocked: false,
  ...
  },
  {
    ...
    rewardDescription: 'The Accelerator Particles upgrade is a lot more powerfull.', style: 'yellow-challenge', resetId: 'yellow-challenges', type: 'yellow-challenges', prestige: 'yellow', unlocked: false,
  ...
  },
  {
    ...
    rewardDescription: 'Gain a multiplier on red generators based on yellow fusion.', style: 'yellow-challenge', resetId: 'yellow-challenges', type: 'yellow-challenges', prestige: 'yellow', unlocked: false,
