...
export const combinerSubject = [
  ...
  },
  {
    ...
    unlocked: false, requirement: ['blueParticles', new Num(1, 4)], active: false, element: 'redAccelerators', buffer: new Num(3, -3), bought: new Num(0, 0)
  },
  {
    ...
    unlocked: false, requirement: ['blueParticles', new Num(1, 4)], active: false, element: 'greenParticles', buffer: new Num(1, 0), bought: new Num(0, 0)
  },
  {
    ...
    unlocked: false, requirement: ['blueParticles', new Num(1, 4)], active: false, element: 'yellowFusion', buffer: new Num(1, -2), bought: new Num(0, 0)
  },
  {
    ...
    unlocked: false, requirement: ['blueParticles', new Num(1, 4)], active: false, element: 'nuclearDecay', buffer: new Num(1, 1), bought: new Num(0, 0)
  },
]
