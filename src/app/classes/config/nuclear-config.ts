...
export class NuclearConfig {
  ...
  static readonly upgrades: NuclearUpgradeConfig[] = [
    ...
    },
    {
      ...
      description: 'Star-Key Compression can be started with 1,000 Yellow Keys, Star Keys immediately empower red generators, and Star-Key upgrades unlock at 1e40 Yellow Particles.',
