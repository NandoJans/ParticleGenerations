...
export abstract class ElementUpgrade extends Upgrade {
  ...
  constructor(
    public element: BlueElementUpgradeSet,
...
export abstract class BlueElementUpgradeSet {
...
export class LithiumElementUpgradeSet extends BlueElementUpgradeSet {
  batteries: Holding;
...
export class BerylliumElementUpgradeSet extends BlueElementUpgradeSet {
  constructor(holding: Holding, theme: string, componentName: string) {
    super(holding, theme, componentName);
  }
...
export class BoronElementUpgradeSet extends BlueElementUpgradeSet {
  constructor(holding: Holding, theme: string, componentName: string) {
    super(holding, theme, componentName);
  }
...
export class CarbonElementUpgradeSet extends BlueElementUpgradeSet {
  constructor(holding: Holding, theme: string, componentName: string) {
    super(holding, theme, componentName);
  }
...
export class OxygenElementUpgradeSet extends BlueElementUpgradeSet {
  constructor(holding: Holding, theme: string, componentName: string) {
    super(holding, theme, componentName);
  }
...
export class ForgedElementUpgradeSet extends BlueElementUpgradeSet {
  constructor(holding: Holding, theme: string, componentName: string) {
    super(holding, theme, componentName);
  }
