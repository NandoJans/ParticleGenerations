...
export interface Generator {name: string, displayName: string, baseCost: Num, cost: Num, increase: Num, scaling: Num, bought: Num, currency: string, generates: string, baseMultiplier: Num, multiplier: Num, amount: Num, type: string, resetId: string, unlocked: boolean, requirement: any[], auto?: boolean, style: string, noMax?: boolean, scalingStart?: Num}
...
export interface Challenge {name: string, displayName: string, description: string, goal: Num, currency: string, prestige: string, rewardDescription: string, style: string, type: string, resetId: string, unlocked: boolean, instantComplete: boolean, disabled: boolean, requirement: any[], reward: Action, nerfs: Action[], completed: boolean}
export interface Combiner {name: string, displayName: string, element: string, cost: Num, currency: string, unlocked: boolean, active: boolean, style: string, type: string, resetId: string, buffer?: Num, requirement: any[], bought: Num}
