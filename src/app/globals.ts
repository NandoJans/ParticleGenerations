...
export interface Challenge {name: string, displayName: string, description: string, goal: Num, currency: string, prestige: string, rewardDescription: string, style: string, type: string, unlocked: boolean, requirement: any[], reward: Action, nerfs: Action[], completed: boolean}
