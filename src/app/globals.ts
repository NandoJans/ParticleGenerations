...
export interface Automator {name: string, displayName: string, cost: Num, currency: string, unlocked: boolean, active: boolean, requirement: any[], bought: Num, type: string, resetId: string, style: string, target: string | string[], targetType: string, waitFor?: Num, layer?: string, nav?: string, subNav?: string, prestigeType?: string}
