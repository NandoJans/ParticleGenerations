...
export interface Milestone {name: string, displayName: string, description: string, style: string, type: string, unlocked: boolean, requirement: any[], cost: Num, currency: string, buffer: Num, action: Action | NewAction | Function}
export interface Challenge {name: string, displayName: string, description: string, goal: Num, currency: string, prestige: string, rewardDescription: string, style: string, type: string, resetId: string, unlocked: boolean, instantComplete: boolean, disabled: boolean, requirement: any[], reward: Action | NewAction | Function, nerfs: Action[] | Function, completed: boolean, effect?: Num}
